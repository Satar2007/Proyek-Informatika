...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div class="group rounded-3xl border border-[#D9B08C]/60 bg-white p-6 shadow-sm shadow-[#4B2E1F]/5 transition hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#4B2E1F]/10">
            ...
            <div class="mt-5 h-1.5 rounded-full bg-[#F1E5D8]">
                <div class="h-1.5 w-3/4 rounded-full bg-emerald-500"></div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
        <a href="{{ route('laporan.harian') }}"
            class="rounded-3xl border border-[#D9B08C]/60 bg-white p-5 shadow-sm shadow-[#4B2E1F]/5 transition hover:-translate-y-0.5 hover:bg-[#FFFDF9] hover:shadow-xl hover:shadow-[#4B2E1F]/10">
            <p class="text-sm font-bold text-[#7B4B2A]/75">
                Laporan Harian
            </p>
            <p class="mt-2 text-xl font-black text-[#4B2E1F]">
        ...
        <a href="{{ route('owner.rekap-kehadiran') }}"
            class="rounded-3xl border border-[#D9B08C]/60 bg-white p-5 shadow-sm shadow-[#4B2E1F]/5 transition hover:-translate-y-0.5 hover:bg-[#FFFDF9] hover:shadow-xl hover:shadow-[#4B2E1F]/10">
            <p class="text-sm font-bold text-[#7B4B2A]/75">
                Rekap Kehadiran
            </p>
